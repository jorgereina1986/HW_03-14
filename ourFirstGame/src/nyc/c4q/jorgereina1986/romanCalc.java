...
/**
 * Created by Jorge Reina on 3/12/15.
 */
...
// TODO: Group 1: Write this function!
     ...
     * @return The value, or -1 if the number isn't in Roman numerals.
     */
...
// `number.charAt(i)` gives the i'th character
        ...
        for (int i = 0; i < number.length(); i++) {
            switch (number.toUpperCase().charAt(i)) {
                case 'M':
                    val += 1000;
                    break;
                case 'D':
        ...
        for (int i = 0; i < number.length() - 3; i++) {
            if (number.toUpperCase().charAt(i) == number.toUpperCase().charAt(i + 1) &&
                    number.toUpperCase().charAt(i + 1) == number.toUpperCase().charAt(i + 2) &&
                    number.toUpperCase().charAt(i + 2) == number.toUpperCase().charAt(i + 3)) {
                val = -1;
            }
        }
        for (int i = 0; i < number.length() - 1; i++) {
            if (number.toUpperCase().charAt(i) == 'C') {
                if (number.toUpperCase().charAt(i + 1) == 'M') {
                    val -= 200;
                } else if (number.toUpperCase().charAt(i + 1) == 'D') {
                    val -= 200;
                }
            }
            if (number.toUpperCase().charAt(i) == 'X') {
                if (number.toUpperCase().charAt(i + 1) == 'C') {
                    val -= 20;
                } else if (number.toUpperCase().charAt(i + 1) == 'L') {
                    val -= 20;
                }
            }
            if (number.toUpperCase().charAt(i) == 'I') {
                if (number.toUpperCase().charAt(i + 1) == 'X') {
                    val -= 2;
                } else if (number.toUpperCase().charAt(i + 1) == 'V') {
                    val -= 2;
                }
            }
        }
